...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteDatabase.execSQL("insert into mitabla(nombre,apellido) values('Nevin','Almanza')");
        sqLiteDatabase.execSQL("insert into mitabla(nombre,apellido) values('Felix','Soto')");
        sqLiteDatabase.execSQL("insert into mitabla(nombre,apellido) values('Mario','Tejada')");
        sqLiteDatabase.execSQL("insert into mitabla(nombre,apellido) values('Abraham','Luna')");
